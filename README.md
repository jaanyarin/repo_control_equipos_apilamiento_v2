...
La versión actual es **1.11.1**. La versión mostrada en `PerfilScreen` y `SettingsScreen` se obtiene automáticamente desde `mobile/package.json` mediante `mobile/src/constants/appVersion.js`.

...
public class CampanaResource {
    ...
    public Response crear(@Valid CampanaDTO dto, @Context SecurityContext context) {
    ...
    @Path("/{id}")
    @RolesAllowed({"Super Admin", "Admin"})
    public Response actualizar(@PathParam("id") Long id, @Valid CampanaDTO dto, @Context SecurityContext context) {

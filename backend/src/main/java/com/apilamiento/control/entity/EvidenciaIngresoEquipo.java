...
@Entity
@Table(name = "fac_evidencias_ingreso_equipo",
        uniqueConstraints = @UniqueConstraint(columnNames = {"equipo_id", "tipo"}))
public class EvidenciaIngresoEquipo {
    @Id
    ...
    private TipoEvidenciaIngreso tipo;
    ...
    public TipoEvidenciaIngreso getTipo() { return tipo; }
    public void setTipo(TipoEvidenciaIngreso tipo) { this.tipo = tipo; }
